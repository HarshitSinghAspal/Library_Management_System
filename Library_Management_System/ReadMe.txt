...
################################################################
Description
Name of .cfile is Library Management System
...
Note7- I have used scanf("%[^\n]%*c",ptr) similar format to store strings as  gets() was giving warning. 
...
NONE
#########################################################################################
Contributions of the team member-
Harshit Singh Aspal made 1,2,3and 4 function in main menuand helped in 5.
Nishant Maheshwari made number 5 and welcome page.
Rohish Charaya did module number helped Harshit in  3 and 4.